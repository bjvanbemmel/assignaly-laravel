<template>
    ...
    >
        ...
        >
            <div
                class="h-full flex-col relative"
            >
                <label>
                </label>
                <button
                    class="relative rounded-md focus-visible:outline-none ring-zinc-600 focus-visible:ring-2 group h-full w-full text-center flex items-center border border-zinc-600 bg-zinc-800 text-sm hover:bg-zinc-800/30"
                >
                    <span
                ...
                <div
                    class="absolute top-full mt-1 max-h-48 overflow-y-scroll w-full bg-zinc-900 shadow-md shadow-900/50 border-x border-t border-zinc-600 rounded-md"
                    v-if="active"
                >
                    <button
